        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
               <?php for($i = 0; $i < count($expirience); $i++): ?>
                ...
                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $expirience[$i]['startDate'] ?> - <span
                class="w3-text-teal"><?php echo $expirience[$i]['endDate'] ?></span></h6>
